/*
    Aqui ira toda la logica del negocio conectando con la BD
 */
package ModeloDAO;
//Heredamos los metodos de la interfaz
...
public class ClaseProductoDAO implements CRUD { //al agregar implements CRUD trae los nombres de los metodos
